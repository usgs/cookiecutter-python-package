...
{{ cookiecutter.project_slug }} will now be installed to the standard location for third-party Python modules on your
computer platform.
...
Disclaimer
----------
{% if cookiecutter.reviewed_and_approved == "yes" or cookiecutter.reviewed_and_approved == "Yes" or cookiecutter.reviewed_and_approved == "y" %}
