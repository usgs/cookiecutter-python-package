...
pyproj contains all the files and directories you need to create a Python project.
...
2. Download pyproj from the repository and extract to a directory of your choice.

   Or, if you have git_ installed you can clone the project::

    $ git clone <remote url to pyproj>
...
pyproj will now be installed to the standard location for third-party Python modules on your
computer platform.
